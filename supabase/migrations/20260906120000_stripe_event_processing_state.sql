...
REVOKE ALL ON FUNCTION claim_stripe_event(TEXT, TEXT, JSONB, INTEGER) FROM PUBLIC;
REVOKE ALL ON FUNCTION complete_stripe_event(TEXT, UUID) FROM PUBLIC;
REVOKE ALL ON FUNCTION release_stripe_event(TEXT, UUID, TEXT) FROM PUBLIC;
REVOKE ALL ON FUNCTION record_stripe_payment_failure(TEXT, UUID, UUID, TIMESTAMPTZ) FROM PUBLIC;
