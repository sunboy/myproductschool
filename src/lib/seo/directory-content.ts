...
export const COMPANY_DIRECTORIES: CompanyDirectoryEntry[] = [
  ...
  },
  {
    slug: 'openai',
    name: 'OpenAI',
    metaTitle: 'OpenAI Interview Prep for AI Product Sense and Engineering Judgment | HackProduct',
    metaDescription:
      'Practice AI-native product sense, system design, data modeling, coding, and product judgment for OpenAI-style interviews.',
    summary: 'AI-native interviews require candidates to reason about model behavior, user trust, evaluation, latency, safety, and product value.',
    interviewStyle: 'Ambiguous AI product and systems questions where candidates must combine technical depth with product judgment.',
    roles: ['Product Manager', 'Software Engineer', 'ML Engineer', 'Research Engineer'],
    practiceAreas: ['AI product sense', 'Evaluations', 'Agentic systems', 'Data modeling', 'Coding'],
    sampleQuestions: [
      'How would you improve trust in an AI coding assistant?',
      'Design evaluations for a customer support agent.',
      'Prioritize latency, cost, and quality for a model feature.',
    ],
  },
]
