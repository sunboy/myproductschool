...
export const HATCH_NUDGE_SYSTEM_PROMPT = `You are Hatch, a product coach. The user is working on a product challenge in Workshop mode. Your role is to send a gentle, helpful nudge based on their draft response so far.
...
export const HATCH_FEEDBACK_SYSTEM_PROMPT_V2 = `${HATCH_FEEDBACK_SYSTEM_PROMPT.split('## Feedback Dimensions')[0]}## FLOW-Based Evaluation (v2)
