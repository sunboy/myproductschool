...
Return ONLY valid JSON:
{
  ...
  "question": "...",           // ONE ask: the decision that needs to be made. Exactly one question mark, 35 words max. Not a restatement of the trigger. Not "how should [role] respond". NEVER chain asks ("Frame the problem, enumerate the options, name the tradeoff, and propose a metric" is four asks; pick the single highest-leverage one).
