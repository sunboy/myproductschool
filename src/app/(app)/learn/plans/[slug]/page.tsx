  ...
  if (error || !plan) {
    return (
      <div className="max-w-7xl mx-auto p-6">
        ...
        <Link href="/learn/plans" className="text-primary text-sm mt-2 inline-block">← Back to Study Plans</Link>
      </div>
    )
  }
        ...
        <section className="col-span-12 lg:col-span-8 space-y-6">
          <div className="bg-white rounded-xl p-5 border border-outline-variant/20 shadow-sm">
            ...
            <nav className="flex items-center gap-2 text-xs text-on-surface-variant mb-4">
              ...
              <Link href="/learn/plans" className="hover:text-primary transition-colors">Study Plans</Link>
              <span className="material-symbols-outlined text-[10px]">chevron_right</span>
