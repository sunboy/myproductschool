...
export function CalibrationHero() {
  const { openModal, hasMeaningfulProgress } = useOnboardingModal()
          ...
          <div className="flex flex-wrap items-center gap-3">
            ...
            >
              <span className="material-symbols-outlined text-base" style={{ fontVariationSettings: "'FILL' 1" }}>
                {hasMeaningfulProgress ? 'play_circle' : 'play_arrow'}
              </span>
              {hasMeaningfulProgress ? 'Resume calibration' : 'Start calibration'}
            </button>
