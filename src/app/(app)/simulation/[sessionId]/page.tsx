      ...
      <div className="max-w-3xl mx-auto px-4 py-6 flex flex-col" style={{ height: 'calc(100vh - 4rem)' }}>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-5 max-w-md">
            <HatchImage size={56} state="celebrating" className="mx-auto" />
      ...
      <div className="flex-1 overflow-y-auto space-y-4 pb-4">
        {turns.map((turn, i) => (
          <div key={i} className={`flex gap-3 ${turn.role === 'user' ? 'flex-row-reverse' : ''}`}>
            {turn.role === 'hatch' && <HatchImage size={24} state="idle" className="flex-shrink-0 mt-1" />}
        ...
        {isSending && (
          <div className="flex gap-3">
            <HatchImage size={24} state="reviewing" className="flex-shrink-0 mt-1" />
