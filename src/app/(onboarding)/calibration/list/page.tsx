    ...
    <div className="px-6 py-6 max-w-3xl mx-auto">
      ...
      <div className="flex items-center gap-1 mb-6 overflow-x-auto">
        {TABS.map((tab) => (
          ...
          >
            {tab.done && <span className="material-symbols-outlined text-base">check_circle</span>}
      ...
      <div className="mb-6">
        ...
        <span className="text-xs font-label text-on-surface-variant">Traditional Easy · SWE · Data</span>
      </div>

      {/* Problem statement */}
      <div className="bg-surface-container-low rounded-xl p-5 mb-4">
        <p className="text-sm text-on-surface font-body">
          The team deployed a share button; metrics show downloads increased 12%, but sessions fell 18% and purchases dropped 9%. The PM questions feature viability; leadership demands answers by Friday.
        </p>
      </div>
      ...
      <div className="flex items-start gap-3 mb-4 bg-surface-container-low rounded-xl p-4">
        ...
        <div>
          ...
          <p className="text-sm text-on-surface font-body mt-1">
            Look at the numbers together before drawing conclusions. Could the increased downloads be coming from a segment that behaves differently?
          </p>
        </div>
      </div>
      ...
      <p className="text-sm text-on-surface-variant font-body mb-4">
        Segment the affected users by behavior. Propose three distinct segments you&apos;d investigate to find the root cause. Target: 80–150 words.
      </p>
