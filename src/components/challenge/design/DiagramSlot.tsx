    ...
    return (
      ...
      >
        ...
        <button
          type="button"
          onClick={onOpen}
          className="inline-flex items-center gap-2 rounded-lg bg-forest-950 px-4 py-2 text-[13px] font-bold text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.08)]"
        >
    ...
    <div className={cn('flex flex-col gap-2', className)}>
      ...
      <div className="flex items-center justify-between">
        ...
        <button
          type="button"
          onClick={onOpen}
          className="inline-flex items-center gap-1.5 text-[12.5px] font-bold text-forest-700"
        >
          Edit diagram
