    ...
    <section className="hero-reference" id="top">
      <div className="hero-reference-shell">
        ...
        <div className="hero-reference-visual" ref={visualRef}>
          ...
          <article className="hero-reference-review hero-reference-layer-card" aria-label="Example review feedback">
            ...
            <div className="hero-reference-review-main">
              <div className="hero-reference-score" aria-label="Example score 86 out of 100">
                <span>86</span>
              </div>
