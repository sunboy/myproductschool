    ...
    <section className="section grading-section" id="grading">
      <div className="page-shell grading-grid">
        <Reveal className="grading-copy">
          ...
          <h2>See how your reasoning is graded.</h2>
          ...
          <ul className="check-list">
            ...
            <li><span><CheckIcon size={16}/></span>Scoring across concrete interview dimensions</li>
        ...
        <Reveal className="product-panel" delay={80}>
          <div className="product-topbar">
            <div><span className="product-dot"/>System Design <span className="muted">/ Submission review</span></div>
            <button type="button">New practice</button>
          </div>
