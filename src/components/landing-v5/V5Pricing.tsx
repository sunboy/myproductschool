      ...
      <div className="page-shell">
        ...
        <div className="pricing-grid">
          <Reveal className="plan-card">
            ...
            <p className="plan-description">Explore every practice area and see how grading works before upgrading.</p>
            <ul>
          ...
          <Reveal delay={65} className="plan-card featured">
            ...
            <ul>
              <li><span><CheckIcon size={15}/></span>Unlimited practice across all five areas</li>
