...
- Candidate `b01d65855e1620731a950cfe26a980b2e98ceb8b` is READY as `dpl_3Mhe4EHhhtsCVNW3Lcyj8tTm8oJh` on the feature-branch preview, with 31 branch-only environment bindings verified unchanged. Landing and authentication changes from `feat/full-product-redesign` are integrated.
