...
| 2. Playwright N2/N3/N4 green | Partial | N2 paywall passed a fresh `10/10` on May 6 after reseeding the fixed E2E personas and aligning the quick-take cap test with duplicate-completion idempotency; N3 discussions passed `10/10`; narrowed N4 auth passed signup/login/forgot-password `3/3`. Full N4 remains out of launch scope per owner direction. |
